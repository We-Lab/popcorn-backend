    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.Actor')),
                ('actor_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.ActorRole')),
        ...
        migrations.AddField(
            model_name='movie',
            name='making_country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.MakingCountry'),
        ),
        migrations.AddField(
            model_name='movie',
            name='rating_kor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.ViewRating'),
        ),
        migrations.AddField(
            model_name='magazine',
            name='movie',
